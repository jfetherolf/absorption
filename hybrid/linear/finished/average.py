...
DATA_FILE_PATTERN = '*abs_hybrid_tcl2_fm_omegac0.1_beta1.0_lamda0.5_split0.5.dat'
MIN_DATA_FILES = 3
...
with open('new_hybrid_tcl2_fm_omegac0.1_beta1.0_lamda0.5_split0.5.dat', 'wt') as averages:
