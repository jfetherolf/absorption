...
#               time, rhos_site,rhos_eig = my_hybrid.propagate(rho_g, 0.0, t_final, dt)
                ...
                omegas, intensities = my_spec.absorption(-4.+eps, 4.+eps, 0.02, rho_g, t_final, dt, dipole_file = 'dipole_hybrid_omegac%0.1f_beta%0.1f.dat'%(omega_c,beta), is_damped=True)

                with open('abs_hybrid_tanh_fm_omegac%0.1f_beta%0.1f_split%0.1f.dat'%(omega_c,beta,omega_split[1]), 'w') as f:
