...
def main():
    ...
    for omega_c in [1.0]:
        for beta in [1.]:
            for method in ['Redfield']:
                for div in [0.5,1,2,4]:
...
#                       omega_split.append(2e-4)
        ...
        #               time, rhos_site,rhos_eig = my_hybrid.propagate(rho_g, 0.0, t_final, dt)
                    ...
                    with open('abs_hybriddimer_%s_PD%s_omegac%0.1f_beta%0.1f_split%0.1f.dat'%(method,PD,omega_c,beta,omega_split[1]), 'w') as f:
