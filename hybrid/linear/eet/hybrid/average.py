...
DATA_FILE_PATTERN = 'eet_markovfm_tauc100.0_T300.0_split4.0_lamda100.0_run*'
MIN_DATA_FILES = 5
...
with open('eet_markovfm_tauc100.0_T300.0_split4.0_lamda100.0_1e5runs.dat', 'wt') as averages:
