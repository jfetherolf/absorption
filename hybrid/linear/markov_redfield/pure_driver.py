...
def main():
    ...
    #               omega_split.append(1e16)
                ...
                spec_dens_1 = [['ohmic-lorentz', lamda, omega_c]]*nbath
                spec_dens_2 = [['cubic-exp', lamda, omega_c]]*nbath


                my_ham = ham.Hamiltonian(ham_sys, ham_sysbath, spec_dens_2, kT)
                my_ham_slow = ham.Hamiltonian(ham_sys, ham_sysbath, spec_dens_1, kT, sample_wigner=True)
                my_ham_fast = ham.Hamiltonian(ham_sys, ham_sysbath, spec_dens_2, kT)
    ...
    #               time, rhos_site,rhos_eig = my_hybrid.propagate(rho_g, 0.0, t_final, dt)
                ...
                with open('abs_hybrid_tcl2pure_omegac%0.1f_beta%0.1f_split%0.1f.dat'%(omega_c,beta,omega_split[1]), 'w') as f:
