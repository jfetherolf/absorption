...
def main():
    ...
    for method in ['TCL2']:
        for lpath in ['nrgsb','rpgsb','nrese','rpese','total']:
            ...
            with open('abs_monomer_%s_%s_dt-%0.0f_tf-%0.0f.dat'%(lpath,method,dt,t_final), 'w') as f:
            ...
            for t2, spectrum in zip(t2s, spectra):
                with open('2d_monomer_%s_t2-%0.1f_%s_dt-%0.0f_tf-%0.0f.dat'%(lpath,t2,method,dt,t_final), 'w') as f:
