        ...
        for beta in [3.]:
            for t_final in [50]:
                for dt in [0.005]:
                    ...
                    with open('redpop_omegac%0.1f_beta%0.1f_lamda%0.1f.dat'%(omega_c,beta,lamda), 'w') as f:
...
#                    with open('redfield_omegac%0.1f_beta%0.1f_lamda%0.1f.dat'%(omega_c,beta,lamda), 'w') as f:
