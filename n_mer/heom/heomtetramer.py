...
#                       times, rhos_site, rhos_eig = my_heom.propagate(rho_g, t_init, t_final, dt)
                        ...
                        omegas, intensities = my_spec.absorption(-4.+eps, 4.+eps, 0.05, rho_g, t_final, dt, dipole_file = 'dipole_heomtrimer_omegac%0.1f_beta%0.1f.dat'%(omega_c,beta), is_damped=True)
