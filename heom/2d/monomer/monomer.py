    ...
    for K in [1]:
        for L in [4]:
            for lpath in ['total']:
                ...
                with open('abs_monomer_HEOM_dt-%0.0f_tf-%0.0f_L-%d_K-%d.dat'%(dt,t_final,L,K), 'w') as f:
                ...
                for t2, spectrum in zip(t2s, spectra):
                    with open('2d_monomer_%s_t2-%0.1f_HEOM_dt-%0.0f_tf-%0.0f_L-%d_K-%d.dat'%(lpath,t2,dt,t_final,L,K), 'w') as f:
