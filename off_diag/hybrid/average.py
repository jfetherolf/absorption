...
DATA_FILE_PATTERN = 'abs_hybrid_diag_omegac1.0_beta1.0_lambda100.0_split1.0_run*.dat'
MIN_DATA_FILES = 2
...
with open('abs_hybrid_diag_omegac1.0_beta1.0_lambda100.0_split1.0_5E3.dat', 'wt') as averages:
